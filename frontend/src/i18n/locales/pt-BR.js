export default {
  ...
  library: {
    ...
    finished: 'Concluído',
    organizerStep: 'Passo {step}/11',
    noActiveDownloads: 'Nenhum download ativo.',
    noOrganizing: 'Nenhuma faixa sendo organizada.',
  },
  apiHealth: {
    title: 'Status das APIs',
    subtitle:
      'Status em tempo real de todas as APIs integradas. Os erros são registrados em /data/API Fehler.log.',
    test: 'Testar APIs',
    testing: 'Testando…',
    ok: 'OK',
    warning: 'Aviso',
  ...
  organizer: {
    ...
    newKeyword: 'palavra1, palavra2, palavra3',
    ...
    soundcloudHint:
      'Necessário para usar o SoundCloud como 6ª fonte de metadados durante a votação.',
    soundcloudPlaceholder: 'Cole client_id…',
    soundcloudDiscover: 'Auto-detectar',
    soundcloudFound: 'Client ID detectado e salvo.',
    soundcloudNotFound:
      'Não foi possível detectar o client ID. Verifique a conectividade e tente novamente.',
    soundcloudNote:
      'O SoundCloud rotaciona esse ID a cada poucos meses. Clique em Auto-detectar novamente quando as buscas pararem de funcionar.',
    separatorTokens: 'Separadores de Artista',
    separatorTokensHint:
      'Ao votar nos nomes de artistas entre as fontes, esses tokens são usados para dividir entradas (ex.: "feat.", "&"). A contagem é feita com nomes individuais.',
    addSeparator: 'Adicionar separador',
    newSeparator: 'ex.: feat.',
    cacheEditor: 'Cache de Conhecimento de Artistas',
    cacheEditorHint:
      'O cache memoriza o gênero e os álbuns conhecidos de cada artista. Na próxima música do mesmo artista, a votação de gênero é pulada automaticamente.',
    cacheCount: '{n} artistas',
    cacheClearAll: 'Limpar tudo',
    cacheClearConfirm: 'Excluir todas as {n} entradas do cache?',
    cacheSearch: 'Pesquisar artista…',
    cacheArtist: 'Artista',
    cacheGenre: 'Gênero',
    cacheAlbum: 'Álbum',
    cacheAlbums: 'Álbuns',
    cacheLearnedOn: 'Aprendido',
    cacheSaved: 'Entrada do cache salva.',
    cacheDeleted: 'Entrada do cache excluída.',
    cacheClearedAll: 'Cache limpo.',
  },
  audit: {
    title: 'Título',
    tooltip: 'Mostrar rastreamento do pipeline de metadados',
    source: 'Fonte',
    genre: 'Gênero',
    artist: 'Artista',
    album: 'Álbum',
    noData:
      'Nenhum rastreamento disponível para esta faixa. Ela pode ter sido processada antes de este recurso ser adicionado.',
    rulesApplied: 'regras alteradas',
    noRulesApplied: 'Nenhuma regra do organizador alterou o resultado.',
    cache: 'Cache-Artista',
    cacheHit: 'Cache de artista encontrado — gênero conhecido',
    cacheWritten: 'Cache de artista atualizado',
    cacheSkipped: 'Passos 1–9 pulados',
    cacheGenreOverwritten: 'Gênero substituído',
    cacheAlbumLearned: 'Novo álbum aprendido',
    cacheAlbumFuzzy: 'Álbum corrigido por correspondência difusa',
  },
  monitor: {
  ...
  cookies: {
    ...
    hint: 'Faça upload de um arquivo cookies.txt para contornar a detecção de bots. Obtenha-o do seu navegador com uma extensão "cookies.txt" enquanto estiver logado no YouTube.',
    statusNone: 'Sem cookies — downloads podem falhar neste IP',
    statusLoaded: 'Cookies carregados — {count} entradas',
    upload: 'Enviar cookies.txt',
    delete: 'Remover cookies',
    uploadSuccess: 'Cookies enviados. Os downloads vão usá-los imediatamente.',
    uploadError: 'Falha no upload. Verifique se o arquivo é um cookies.txt válido.',
    emptyFile: 'O arquivo selecionado está vazio. Exporte seus cookies novamente.',
    deleteSuccess: 'Cookies removidos.',
    deleteError: 'Não foi possível remover os cookies.',
  },
  footer: {
