export default {
  ...
  organizer: {
    ...
    cacheEditor: 'Metadata Cache',
    cacheEditorHint:
      'The cache stores resolved metadata after all 11 steps. A cache hit skips API lookups and applies fresh organizer rules. Manual entries are permanent.',
    cacheCount: '{n} entries',
    cacheClearAll: 'Clear all',
    cacheClearConfirm: 'Delete all {n} cache entries?',
    cacheAdd: 'Add entry',
    cacheSearch: 'Search artist or title…',
    cacheArtist: 'Artist',
    cacheTitle: 'Title',
    cacheGenre: 'Genre',
    cacheAlbum: 'Album',
    cacheAddTitle: 'Add cache entry',
  ...
  audit: {
    ...
    cache: 'Cache',
    cacheHit: 'Cache hit — steps 1–10 skipped',
    cacheWritten: 'Result written to cache',
  },
  monitor: {
